 ...
 * @author ESTUDIANTE
 */
public class FacturaInt extends javax.swing.JFrame {

    /**
     * Creates new form FacturaInt
     */
    public FacturaInt() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacturaInt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacturaInt().setVisible(true);
            }
        });
    }
